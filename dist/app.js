...
ShareBox.Form = React.createClass({displayName: "Form",
  ...
  render: function(){
    return (
      React.createElement("form", {className: "shareForm", onSubmit:  this.handleSubmit}, 
        React.createElement("input", {type: "text", placeholder: "Example: http://google.com", ref: "url"}), 
...
ShareBox.List = React.createClass({displayName: "List",
  render: function(){
    var shareNodes = this.props.data.map(function(shareResult, index){
      return (
        React.createElement(ShareBox.Result, React.__spread({
          key: index, 
    ...
    if (shareNodes.length) {
      clearButton = (
        React.createElement("button", {type: "button", onClick:  this.props.onShareClear}, "Clear")
      );
    }
    return (
      React.createElement("div", {className: "shareList"}, 
        clearButton, 
        shareNodes 
      )
    );
...
ShareBox.Result = React.createClass({displayName: "Result",
  render: function(){
    return (
      React.createElement("div", {className: "shareResult"}, 
        React.createElement("dl", null, 
          React.createElement("dt", null, "Source"), 
          React.createElement("dd", null,  this.props.source), 
          React.createElement("dt", null, "Title"), 
          React.createElement("dd", null,  this.props.title), 
          React.createElement("dt", null, "Description"), 
          React.createElement("dd", null,  this.props.description), 
          React.createElement("dt", null, "Canonical"), 
          React.createElement("dd", null,  this.props.canonical), 
          React.createElement("dt", null, "Image"), 
          React.createElement("dd", null,  this.props.image), 
          React.createElement("dt", null, "Favicon"), 
          React.createElement("dd", null,  this.props.favicon)
        ), 

        React.createElement("button", {type: "button", onClick:  this.props.onDelete}, "Delete")
      )
    );
  }
});
